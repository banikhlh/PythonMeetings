...
@bot.message_handler(
    func=lambda message: online_offline(message.from_user.username) != "online"
    and message.text == "Register"
)
...
@bot.message_handler(
    func=lambda message: online_offline(message.from_user.username) == "online"
    and message.text == "Create meeting"
)
...
@bot.message_handler(
    func=lambda message: message.from_user.id == config.tg_id_admin
    and message.text == "Console"
)
